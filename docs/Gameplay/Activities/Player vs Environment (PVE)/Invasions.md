...
**Invasions** are PvE events where NPC forces attack and players work together to defeat them. Winning an invasion and killing invasion NPCs (including bosses) gives strong rewards.
...
| **Party Box activities** | [Party Box](/Gameplay/index.md) activities can include **"Invasion Victory"** — complete the task for bonus loot (e.g. 1 in 25 chance of an advanced Tech Computer). |

## Pity Loot Note

Invasion boss loot and other non-standard invasion drops **do not reset** your [pity loot](/Items/Pity-Loot.md) counters. Your normal pity progress is unchanged.
