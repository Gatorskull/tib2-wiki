...
## Differences from the Primary Server

| Rule | Oblivion | Primary |
|------|----------|---------|
| **Loot / XP / Crafting** | Accelerated | Normal |
| **PvP** | Everywhere except systems near Earth | Only in non-human systems |
| **Ships on Jump Gates** | Can be attacked in PvP maps | Relatively safe when not in combat |
| **Corporation size** | Max **15** members | Larger |
| **Alliance size** | Max **2** corporations | Up to 6 |
| **Item repair** | **Cannot** repair items | Can repair |
| **Items to Ultimate** | **Cannot** upgrade with Tech Points | Can upgrade |
...
| **Crafters** | Can create **Legendary and Ultimate** items | Restricted |
| **Free ships / relic level-up** | **No** free ships or relic level-up rewards | Yes |
