...
* **Item upgrades** -- Rank items up or down; upgrade [rarity](../../Items/Item-Upgrades.md) (e.g. Rare -> Ultra-Rare) via the item inspect panel.
...
* [Item Upgrades](../../Items/Item-Upgrades.md) -- Rarity, rank, quality, and repair uses
* [Tech Points Quick Start](../../Getting-Started/Quick-Start-Guides/Tech-Points-Quick-Start.md) -- cattabliss' practical TP spending guide
