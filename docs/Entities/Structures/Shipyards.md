...
**Shipyards** [**construct**](../../Ships/Ship-Crafting.md) new [**ships**](../../Ships/index.md) for corporation members and unlock new blueprints as they level up. Each corporation can have up to **4 Shipyards**.

## Capacity & Factions

| Feature | Details |
|---------|---------|
| **Limit** | Up to **4** Shipyards per corporation. |
...
| **Hull/Shield** | **+Max Hull** and **+Max Shield** stats are multiplied by **x12**. |
