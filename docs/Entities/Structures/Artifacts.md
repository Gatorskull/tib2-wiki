...
## Studying Artifacts (Skill Points)
...
| Aspect | Detail |
|--------|--------|
| **Count** | 50+ artifacts in the universe |
| **Stored at** | Corp [Planets](Planets.md) and [Garrisons](Garrisons.md) |
| **Corp benefit** | Tech bonus for all corp members while controlled |
| **Player benefit** | Study = +1 Skill Point (permanent) |
| **Study access** | Anyone if uncaptured; only alliance members if corp-captured |
