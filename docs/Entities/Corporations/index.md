...
Corporations earn **XP from every kill**, then level up and train [**skills**](../../Gameplay/Skills.md) just like players. A corporation's skill and technology choices apply to **all ships** owned by its members.

### Starting structures

Every corporation begins with:

* One [**Planet**](../Structures/Planets.md)
* One [**Garrison**](../Structures/Garrisons.md)
* One [**Outpost**](../Structures/Outposts.md)
* One [**Shipyard**](../Structures/Shipyards.md)

These [**defense units**](../Structures/index.md) are leveled up using **resource deposits**, which unlock more [**Equip Points**](../../Ships/Equip-Points.md) and gear slots. Defense units may be deployed in PvP [**system maps**](../../World/Maps/index.md) to grow corporation and [**alliance**](Alliances.md) territory.
