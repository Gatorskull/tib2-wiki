...
**Void items** are a rare, powerful variant of regular equipment. Each has an **extra stat bonus** (similar to mutated items) that **grows stronger** as you upgrade the item's rarity. Void gear also gains **more [stats](Stats.md)** from item quality, making it better than equivalent non-Void gear.

## How to Get Void Items
