...
From the Starmap you can see systems, [**Security Ratings**](Security%20Rating.md), and plan travel. Use [**Jump Gates**](/Entities/Structures/Jump%20Gates.md) to move between systems.
...
| **Other factions (PvP)** | [**PvP possible**](/Gameplay/Activities/Player%20vs%20Player%20(PVP)/index.md) | Different coloring |
...
Cost: **1 [Tech Point](/Entities/Currencies/Tech%20Points.md)** per jump (no matter how many ships move).
...
| Topic | Description |
|-------|-------------|
| [**Security Rating**](Security%20Rating.md) | SR1–SR9: how dangerous a system is and what to expect. |
...
* [The World](/World/index.md) — Map grid and navigation
* [Jump Gates](/Entities/Structures/Jump%20Gates.md) — Moving between systems
* [PvP](/Gameplay/Activities/Player%20vs%20Player%20(PVP)/index.md) — Where and why to fight
