...
## Crafting Ultimate and Interdictor
...
| Mod | Key benefit | Limitation / source |
|-----|-------------|----------------------|
| Medic | Repair + Technician | Any ship |
| Gladiator | Vorpal, Savior; crits vs injured | Arena (100 wins) |
| Phoenix | Rebirth (save from death), Savior | Invasions; no Hardcore |
| Raider | Bonus damage vs players & defenses | Any ship |
| Interdictor | Sector slow for enemies; one per sector | Carrier only; crafted |
| Freighter | Harvesting bonus, less damage | Any ship |
| Paladin | Max hull, defensive tech | Emperor craft bonus only |
| Ultimate | +4 EP, extra slots; one deployed | Crafted (fragments + Relics) |
