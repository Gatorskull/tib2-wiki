...
## Hardcore Penalties and Rules

- **Drop on death** -- When a Hardcore unit dies, it drops **1 random equipped item**.
- **No free newbie gear** -- Hardcore units **cannot** equip free starter/newbie gear.
- **Durability** -- Hardcore units lose **slightly more** durability on death than non-Hardcore.

So Hardcore is high risk, high reward: better stats and EP, but death costs you an item and more durability.
...
- Hardcore ships that get the killing shot generate [**pity loot**](../Items/Pity-Loot.md) at **2x** the Oblivion accelerated rate, stacking with other loot bonuses (e.g. up to 10x or more during invasions).
...
| Aspect | Detail |
|--------|--------|
| **Bonuses** | -10% move cooldown, +25 Skill Points, +3 EP (ships) or +10 EP (defenses), +5 extra investable Skill Points |
| **Death** | Drops 1 random equipped item; more durability loss |
| **Restrictions** | No newbie gear; no Corp Defender use; no Phoenix mod |
| **Oblivion** | 100% durability loss and drop all items on death; 2x pity loot on killing shot |
